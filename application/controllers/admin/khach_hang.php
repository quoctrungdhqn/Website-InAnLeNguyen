...
class Khach_hang extends CI_Controller {
	...
	public function view() {
	    ...
	    $list = $this->Khach_hang_model->getSliders();			
		$data['list'] = $list;
		
		$this->template->write_view("content","admin/khach_hang/khach_hang_list",$data);
	...
	public function edit($id = null)
	{
		...
		else
		{
			...
			$data['info'] = $this->Khach_hang_model->getSlideInfo($id);
			$list = $data['info'];			
		}			
		$this->template->write_view("content","admin/khach_hang/khach_hang_edit",$data);
		$this->template->render();
	}
    ...
    public function save_update()
	{
		...
		if(!$id) 
		{
			if($this->Khach_hang_model->insertslide($image))
			{
				$this->session->set_userdata(array('message' => 'Thêm thành công!'));
				redirect('admin/khach_hang/view/');
			}
			else
			{
		...
		{
			if($this->Khach_hang_model->updateslide($image))
			{
    ...
    {        
            ...
            $this->Khach_hang_model->deleteItem($id);       
