...
class Product extends CI_Controller {
	...
	{		
        ...
        //require_once(FCPATH.'third_party/ckfinder.php');
   ...
   public function delete($id)

	{
		...
		if($this->Product_model->deleteItem($id))

		{

			$this->session->set_userdata(array('message' => 'Xoá thành công!'));
...

		{
			...
			$this->session->set_userdata(array('message' => 'Xoá thất bại!'));
