...
class Video extends CI_Controller {
    ...
    public function view($message = null) {
        ...
        $list = $this->Video_model->getvideo();
        $data['list'] = $list;
        $this->template->write_view("content","admin/video/video_list",$data);
    ...
    public function edit($id = null)
    {
        ...
        else
        {
            ...
            $data['info'] = $this->Video_model->getvideoInfo($id);
            $list = $data['info'];
        }
        $this->template->write_view("content","admin/video/video_edit",$data);
        $this->template->render();
    }
    ...
    public function save_update()
    {
        ...
        if(!$id)
        {
            if($this->Video_model->insertvideo($image))
            {
        ...
        {
            if($this->Video_model->updatevideo($image))
            {
    ...
    public function delete($id)
    {
        ...
        $this->Video_model->deleteItem($id);
