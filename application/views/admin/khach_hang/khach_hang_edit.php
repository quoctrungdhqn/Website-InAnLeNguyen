<div class="col-lg-12">
	...
	<form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/khach_hang/save_update/" method="post" name="form-view" enctype="multipart/form-data">
			...
			<div role="tabpanel" class="tab-pane active" id="home">				
                    <fieldset>
                        <legend>
    						...
    						<a href="<?php echo base_url() ?>admin/khach_hang/view/" class="btn btn-default">Hủy</a>
                        </legend>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label" for="typeahead">Công ty </label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control col-md-6" name="link" value="<?php echo @$info->link;?>" placeholder="Nhập link" >                
                            </div>
                        </div>                      
                     <!--   <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p class="help-block">Kích thước chuẩn 200*100.</p>
                                <?php                            	
                                    if(@$info->image != '')
                                    {
                                    	$img = explode(',',$info->image);                                    	
                                ?>
                                    <p><img width="200" height="100" src="<?php echo base_url(); ?>uploads/khach_hang/thumb_<?php echo $img[0]; ?>" /></p> 
        						<?php } ?>
                		...
                		<label class="col-lg-2 control-label" for="typeahead">Mô tả chi tiết </label>            		
                		  <div class="form-group">                		   	                
			                <div class="col-lg-12">                                 
			                    <textarea class="tinymcefull" rows="15" name="description"><?php echo @$info->description; ?></textarea>               
			                </div>
                		</div>
                    </fieldset>
