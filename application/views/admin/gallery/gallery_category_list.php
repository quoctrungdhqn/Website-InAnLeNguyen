	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<div class="text-muted bootstrap-admin-box-title">
				<?php echo $page_title; ?>
				<a href="<?php echo base_url()?>admin/gallery_category/edit" title="Click vào để thêm mới" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> Thêm mới</a>
			</div>
		</div>
		...
		<div class="bootstrap-admin-panel-content">
			<table class="table table-striped table-bordered" id="example">
                ...
                <?php foreach($list as $items):?>
                    <tr class="odd gradeX">
	                    <td><a href="<?php echo base_url()?>admin/gallery_category/edit/<?php echo $items->id;?>"><?php echo $items->title;?></a></td>	                    
	                    ...
	                    <td class="actions">	                        
	                            <a class="btn btn-sm btn-primary" href="<?php echo base_url()?>admin/gallery_category/edit/<?php echo $items->id;?>">
	                                <i class="glyphicon glyphicon-pencil"></i>
	                                Sửa
	                            </a>
	                                               
	                        <a class="btn btn-sm btn-danger" href="<?php echo base_url()?>admin/gallery_category/delete/<?php echo $items->id;?>">	                            
