<div class="col-lg-12">
	...
	<form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/download/save_update/" method="post" name="form-view" enctype="multipart/form-data">
			...
			<div role="tabpanel" class="tab-pane active" id="home">				
                    <fieldset>
                        <legend>
    						...
    						<a href="<?php echo base_url() ?>admin/download/view/" class="btn btn-default">Hủy</a>
                        </legend>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label" for="fileInput">Tài liệu/Văn bản</label>
                            <div class="col-lg-10">
                                ...
                                ?>
                                    <p>Link tài liệu : <a href="<?php echo base_url()?>uploads/downloads/<?php echo $img[0];?>"><?php echo $img[0];?></a></p> 
        						<?php } ?>
