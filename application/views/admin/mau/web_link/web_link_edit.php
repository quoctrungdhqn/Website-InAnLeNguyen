<div class="col-lg-12">
	...
	<form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/web_link/save_update/" method="post" name="form-view" enctype="multipart/form-data">
			...
			<div role="tabpanel" class="tab-pane active" id="home">				
                    <fieldset>
                        <legend>
    						...
    						<a href="<?php echo base_url() ?>admin/web_link/view/" class="btn btn-default">Hủy</a>
                        </legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                ?>
                                    <p><img width="200" height="100" src="<?php echo base_url(); ?>uploads/web_link/thumb_<?php echo $img[0]; ?>" /></p> 
        						<?php } ?>
