...
<div class="col-lg-12">
	...
	<form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/page/save_update/" method="post" name="form-view" enctype="multipart/form-data">
			...
			<div role="tabpanel" class="tab-pane active" id="home">				
                    <fieldset>
                        <legend>
    						...
    						<a href="<?php echo base_url() ?>admin/page/view/" class="btn btn-default">Hủy</a>
                        </legend>
