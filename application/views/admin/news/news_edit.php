...
<div class="col-lg-12">
	...
	<form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/news/save_update/" method="post" name="form-view" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                ?>
                                    <p><img width="100" height="80" src="<?php echo base_url(); ?>uploads/news/thumb_<?php echo $img[0]; ?>" /></p> 
        						<?php } ?>
                        ...
                        <div class="form-group">
                              <label class="col-lg-2 control-label" for="fileInput">Hiển thị tin ở slide trang chủ</label>                 
                                    <input type="radio" name="featured" id="featured" value="1" <?php if(@$info->featured == '1') echo set_radio('featured', '1', TRUE); ?> />
                                    Hiển thị&nbsp;&nbsp;&nbsp;                                
                                    <input type="radio" name="featured" id="featured2" value="0" <?php if(@$info->featured == '0') echo set_radio('featured', '0', TRUE); ?> />
                                   Ẩn                                                
                        </div>                      
