	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<div class="text-muted bootstrap-admin-box-title">
				<?php echo $page_title; ?>
				<a href="<?php echo base_url()?>admin/product_category/edit" title="Click vào để thêm mới" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> Thêm mới</a>
			</div>
		</div>
			...
			<table class="table table-striped table-bordered" id="example">
                ...
                <?php foreach($list as $product):?>
                    <tr class="odd gradeX">
	                    ...
	                    <td class="actions">	                        
	                            <a class="btn btn-sm btn-primary" href="<?php echo base_url()?>admin/product_category/edit/<?php echo $product->id;?>">
	                                <i class="glyphicon glyphicon-pencil"></i>
	                                Sửa
	                            </a>
	                                               
	                        <a class="btn btn-sm btn-danger" href="<?php echo base_url()?>admin/product_category/delete/<?php echo $product->id;?>">	                            
