<div class="col-lg-12">
	...
	<form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/product_category/save_update/" method="post" name="form-view" enctype="multipart/form-data">
			...
			<div role="tabpanel" class="tab-pane active" id="home">				
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" required="" class="form-control col-md-6" name="name" value="<?php echo @$catInfo->name ?>">                
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" required="" class="form-control col-md-6" name="name_en" value="<?php echo @$catInfo->name_en ?>">                
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control col-md-6" name="alias" value="<?php echo @$catInfo->alias;?>" placeholder="Alias tự sinh,không cần nhập" >                
                            </div>
                        </div>
                        <div class="form-group">
                       ...
                       <!-- <div class="form-group">
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control col-md-6" name="link" value="<?php echo @$catInfo->link;?>" placeholder="Vui lòng nhập link..." >                
                            </div>
                        </div>
                      	<div class="form-group">
                              <label class="col-lg-2 control-label" for="fileInput">Bật/Tắt</label>                 
                                    <input type="radio" name="state" id="state" value="1" <?php if(@$catInfo->state == '1') echo set_radio('state', '1', TRUE); ?> />
                                    Hiển thị&nbsp;&nbsp;&nbsp;                                
                                    <input type="radio" name="state" id="state2" value="0" <?php if(@$catInfo->state == '0') echo set_radio('state', '0', TRUE); ?> />
                                   Ẩn                                                
                        </div>                      
                		...
                		<label class="col-lg-2 control-label" for="typeahead">Mô tả chi tiết </label>            		
                		  <div class="form-group">                		   	                
			                <div class="col-lg-12">                                 
			                    <textarea class="tinymcefull" rows="15" name="detail"><?php echo @$catInfo->detail; ?></textarea>               
			                </div>
                		</div>
                    </fieldset>
			    ...
			    <fieldset>
	                <legend><?php echo $page_title;?></legend>
					 <div class="form-group">
			                ...
			                <div class="col-lg-10">                                 
			                    <textarea class="form-control" name="seo_title" rows="3" placeholder="Nhập title SEO ..."><?php echo @$catInfo->seo_title; ?></textarea>               
			                </div>
	                	</div>
	    				<div class="form-group">
			                <label class="col-lg-2 control-label" for="typeahead">SEO keyword </label>
			                <div class="col-lg-10">                                 
			                    <textarea class="form-control" name="seo_keyword" rows="3" placeholder="Nhập keyword SEO ..."><?php echo @$catInfo->seo_keyword; ?></textarea>               
			                </div>
                		</div>
	    				<div class="form-group">
			                <label class="col-lg-2 control-label" for="typeahead">SEO description </label>
			                <div class="col-lg-10">                                 
			                    <textarea class="form-control" name="seo_description" rows="3" placeholder="Nhập description SEO ..."><?php echo @$catInfo->seo_description; ?></textarea>               
			                </div>
                		</div> 
				</fieldset>  
		    </div>	
