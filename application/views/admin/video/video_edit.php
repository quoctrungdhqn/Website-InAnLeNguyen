<div class="col-lg-12">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
        ...
        <form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/video/save_update/" method="post" name="form-view" enctype="multipart/form-data">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <fieldset>
                            <legend>
                                ...
                                <a href="<?php echo base_url() ?>admin/video/view/" class="btn btn-default">Hủy</a>
                            </legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <p class="help-block">Kích thước chuẩn 1349*500.</p>
                                    <?php
                                    if(@$info->image != '')
                                    {
                                        $img = explode(',',$info->image);
                                        ?>
                                        <p><img width="100" height="80" src="<?php echo base_url(); ?>uploads/slide/thumb_<?php echo $img[0]; ?>" /></p>
                                    <?php } ?>
