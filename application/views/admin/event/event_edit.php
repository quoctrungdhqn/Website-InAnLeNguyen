<div class="col-lg-12">
	...
	<form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/event/save_update/" method="post" name="form-view" enctype="multipart/form-data">
			...
			<div role="tabpanel" class="tab-pane active" id="home">				
                    <fieldset>
                        <legend>
    						...
    						<a href="<?php echo base_url() ?>admin/event/view/" class="btn btn-default">Hủy</a>
                        </legend>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label" for="typeahead">Loại sự kiện </label>
                           <div class="col-lg-10">
                                <select id="select01" name="type" class="chzn-select" style="width: 150px">                                
                                	<option <?php if($info->type=='1')echo "selected='selected'";?> value="1">Up comming</option>
                                	<option <?php if($info->type=='2')echo "selected='selected'";?> value="2">Archive</option>                              
                                </select>
                            </div>
                        </div>                        
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                ?>
                                    <p><img width="100" height="80" src="<?php echo base_url(); ?>uploads/event/thumb_<?php echo $img[0]; ?>" /></p> 
        						<?php } ?>
